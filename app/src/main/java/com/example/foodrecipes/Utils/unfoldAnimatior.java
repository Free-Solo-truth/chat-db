...
public class unfoldAnimatior {
     ...
     */
    public static unfoldAnimatior newInstance(Context context, View hideView, View down, int width){
        return new unfoldAnimatior(context,hideView,down,width);
    }

    private unfoldAnimatior(Context context, View hideView, View down, int width){
